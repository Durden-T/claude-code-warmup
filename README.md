...
| `WARMUP_MESSAGES` | ❌ | *"Hello! This is an automated warm-up..."* | Plain string or JSON array (e.g. `["msg1","msg2"]`). One is picked randomly per day. Falls back to `WARMUP_MESSAGE` for backward compatibility |
